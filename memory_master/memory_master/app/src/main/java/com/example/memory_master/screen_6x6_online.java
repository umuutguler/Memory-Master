...
public class screen_6x6_online extends AppCompatActivity {
    ...
    private void checkEnd(){
        if (hl_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(screen_6x6_online.this);
            alertDialogBuilder
                    ...
                    .setPositiveButton("YENİ OYUN", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(getApplicationContext(), screen_6x6_online.class);
